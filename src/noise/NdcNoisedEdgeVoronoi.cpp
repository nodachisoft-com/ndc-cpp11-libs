...
{
  float xDelta1 = xNoise1.pnoise2(x * 2, y * 2, width, height, 2.0f * 0.3f / width);
  float xDelta2 = xNoise2.pnoise2(x * 4, y * 4, width, height, 2.0f * 0.7f / width);
  float yDelta1 = yNoise1.pnoise2(x * 2, y * 2, width, height, 2.0f * 0.3f / height);
  float yDelta2 = yNoise2.pnoise2(x * 4, y * 4, width, height, 2.0f * 0.7f / height);
